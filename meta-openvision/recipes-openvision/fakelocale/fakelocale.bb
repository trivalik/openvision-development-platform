...
LANGUAGES = "ar_AE bg_BG ca_AD cs_CZ da_DK de_DE el_GR en_EN es_ES et_EE fa_IR fi_FI \
	fr_FR fy_NL he_IL hr_HR hu_HU id_ID is_IS it_IT ku_TR lt_LT lv_LV nl_NL nb_NO nn_NO pl_PL pt_BR pt_PT \
...
RPROVIDES_${PN} = "virtual-locale-ar virtual-locale-bg virtual-locale-ca virtual-locale-cs \
	...
	virtual-locale-it virtual-locale-ku virtual-locale-lt virtual-locale-lv virtual-locale-nb virtual-locale-nl \
	virtual-locale-nn virtual-locale-pl virtual-locale-pt virtual-locale-ro virtual-locale-ru virtual-locale-sk \
