...
do_install() {
        ...
        install -m 0644 ${S}${base_libdir}/firmware/component_7105* ${D}${nonarch_base_libdir}/firmware
        ln -sf ${nonarch_base_libdir}/firmware/component_7105_hdk7105.fw ${D}${nonarch_base_libdir}/firmware/component.fw
        install -m 0644 ${S}${base_libdir}/firmware/fdvo0_7105.fw ${D}${nonarch_base_libdir}/firmware/fdvo0.fw
